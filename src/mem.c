...
mem init_mem( uint32_t nseg ) {
    ...
    mem vm = calloc( nseg, sizeof( *vm ) ); /* nseg correspond au nombre de segment */ 
 ...
 * @param name the name of the segment to look for (e.g., ".text", ".data", ".rodata" or ".bss")
...
/**
* affiche le contenu de la mémoire virtuelle
